export default function orderFailedTemplate({ user }: Order) {
      ...
      <div style="padding: 24px">
        <div>
          <h1 style="font-size: 32px; font-weight: bold; margin-bottom: 16px">
            Hey <b>${firstName}</b>, Your Order has been Failed!
          </h1>
          <p>
            Your order has been failed, Thank you for Shopping with DAAT FOODS!.
          </p>
        </div>
