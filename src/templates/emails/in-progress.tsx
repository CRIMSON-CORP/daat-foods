export default function orderInprogressTemplate({ user }: Order) {
      ...
      <div style="padding: 24px">
        <div>
          <h1 style="font-size: 32px; font-weight: bold; margin-bottom: 16px">
            Hey <b>${firstName}</b>, Your Order is on its Way!
          </h1>
          <p>
            Your order has been packed and is ready to be delivered to you today!. Please make sure your money is complete and stick to your phone as we might reach out to you for directions.
          </p>
        </div>
